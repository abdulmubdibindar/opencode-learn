...
Do NOT load: seluruh isi `referensi/dunn-2017/` dan `fyfe-concreteness-fading/` sekaligus — baca bagian yang relevan lewat `_index.md` subfolder.
...
## Human check
Baca `peta-isu.md`; verifikasi tiap isu benar dari sumber di `referensi/`, bukan dari ingatan. Edit di tempat — stage berikut membaca apa yang ada di sini.
